    ...
    return (
        <motion.div
            ...
            <div className='w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col'>
                ...
                {/* cart total section  */}
                <div className='w-full flex-1 bg-cartTotal rounded-t-[2rem] flex flex-col items-center justify-between px-8 py-2'>
                    <div className="w-full flex items-center justify-between">
                        <p className="text-gray-400 text-lg">Sub Total</p>
                        <p className="text-gray-400 text-lg">NPR - {tot}</p>
                    </div>
                    <div className="w-full flex items-center justify-between">
                        <p className="text-gray-400 text-lg">Delivery Charge</p>
                        <p className="text-gray-400 text-lg">NPR - 50</p>
                    </div>

                    <div className="w-full border-b border-gray-60 my-2">

                    </div>
                    <div className="w-full flex items-center justify-between">
                        <p className="text-gray-200 text-xl font-semibold">Total</p>
                        <p className="text-gray-200 text-xl font-semibold">NPR - {tot + 50}</p>
                    </div>
