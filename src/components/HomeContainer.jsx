        ...
        <section id='home' className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full'>
            <div className="py-2 flex-1 flex flex-col items-start md:items-start justify-center gap-6">
                <div className='flex items-center gap-2 justify-center bg-orange-100 px-4 py-1 rounded-full'>
                    <p className='text-base text-orange-500 font-semibold'>Book Delivery</p>
                ...
                <p className='text-base text-textColor text-center md:text-left md:w-[80%] relative'>
                That's the thing about books. They let you travel without moving your feet.
                <span className='absolute right-3 -bottom-3 text-base font-semibold'>- Jhumpa Lahiri</span>
                </p>

                <p className='text-base text-textColor text-center md:text-left md:w-[80%] relative'>
                There is no friend as loyal as a book.
                <span className='absolute right-3 -bottom-3 text-base font-semibold'>- Ernest Hemingway</span>
                </p>
